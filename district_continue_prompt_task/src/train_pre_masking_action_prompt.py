...
from dataset_masking_prompt_action import CRSDataset, CRSDataCollator
...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            # loss_discrete_utility_l--dataset redial  --tokenizer ../model/DialogGPT --model ../model/DialogGPT --text_tokenizer ../model/roberta-base --text_encoder ../model/roberta-base --num_train_epochs 3 --gradient_accumulation_steps 1 --per_device_train_batch_size 16 --per_device_eval_batch_size 32 --num_warmup_steps 3333 --max_length 200 --prompt_max_length 200 --entity_max_length 32 --learning_rate 5e-5 --output_dir ../output/action_pre/dialogpt_redial_resp_5e-5_repetition --project Hybrid_CRS --name pre_action --log_all --key_name action --use_wandb --num_conti1 10 --num_conti2 10ong, scores=net4bert_discrete(batch['discrete_utility_long']['discrete_utility_input_ids'].to(device),batch['discrete_utility_long']['discrete_utility_attention_mask'].to(device),batch['discrete_utility_long']['discrete_utility_target'].to(device))
